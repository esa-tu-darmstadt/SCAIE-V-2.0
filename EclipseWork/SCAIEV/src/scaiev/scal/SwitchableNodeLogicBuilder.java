...
public abstract class SwitchableNodeLogicBuilder extends TriggerableNodeLogicBuilder {
	 ...
	 */
	public SwitchableNodeLogicBuilder(String name, NodeInstanceDesc.Key nodeKey) {
		super(name, nodeKey);
	}
	 ...
	 * @param fn with args (NodeRegistryRO registry, int aux), implements {@link SwitchableNodeLogicBuilder#applySwitched(NodeRegistryRO, int)}
	 * @return 
	 */
	public static SwitchableNodeLogicBuilder fromFunction(String name, NodeInstanceDesc.Key triggerNodeKey, BiFunction<NodeRegistryRO, Integer, NodeLogicBlock> fn) {
	 ...
	 * @param name name for toString
	 * @param triggerNodeKey the key to use for triggering; its Purpose value will be replaced with a new one; ISAX and aux will be ignored for implementation reasons
	 * @param fn with args (NodeRegistryRO registry), implements {@link SwitchableNodeLogicBuilder#applySwitched(NodeRegistryRO, int)} ignoring the aux parameter
	 * @return 
	 */
	public static SwitchableNodeLogicBuilder fromFunction(String name, NodeInstanceDesc.Key triggerNodeKey, Function<NodeRegistryRO, NodeLogicBlock> fn) {
		return new SwitchableNodeLogicBuilder(name, triggerNodeKey) {
			@Override
			public NodeLogicBlock applySwitched(NodeRegistryRO registry, int aux) {
