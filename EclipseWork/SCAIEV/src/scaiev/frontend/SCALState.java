...
private HashSet<String> textInterface = new  HashSet<String>();
	...
	private String[] ModuleLogic (SCAIEVNode RdNode, int firststage, int writebackstage, int lastread, boolean commonsigs, boolean justSpawn) {
		...
		String interf = "    input  "+RdNode_validReq+"_"+firststage+"_i,\n"
				...
				+ "	\n"
				+ "	   input ["+addrW+" -1 : 0] "+WrNode_spawn_addr+"_"+spawn+"_i = 0,\n"
	...
	if(commonsigs)
		...
		String module  = ""
				...
				+ "\n"				
				+ "// Regfile \n"				
				+ "wire ["+regW+"-1: 0]"+  WrNode+"_"+firststage+"_s;\n"
				+ "wire ["+regW+"-1: 0]"+  WrNode+"_"+secondstage+"_s;\n"
				+ "wire ["+regW+"-1: 0]"+  WrNode+"_"+thirdstage+"_s;\n"
				+ "`ifdef "+MULTIPLEREGS+"\n"
				...
				+ "        "+WrNode+"_"+(writebackstage+1)+"_reg["+WrNode_spawn_validReq+"_"+spawn+"_i ? "+WrNode_spawn_addr+"_"+spawn+"_i : "+RdInstr+"_"+writebackstage+"_i[7+"+addrW+"-1:7]] <= "+WrNode_spawn_validReq+"_"+spawn+"_i ? "+WrNode_spawn+"_"+spawn+"_i : "+WrNode+"_"+writebackstage+"_s;\n"
				+ "end;\n"
				+ "`else\n"
				...
				+ "`endif"
				+ " \n"
				+ "  assign  "+WrNode+"_"+firststage+"_s = "+WrNode+"_"+writebackstage+"_i;\n"
				+ "// Pipeline results \n"
				...
				+ "	end\n"
				+ "  assign  "+WrNode+"_"+secondstage+"_s = "+WrNode_validData+"_"+writebackstage+"_reg ?  "+WrNode+"_"+writebackstage+"_reg : "+WrNode+"_"+writebackstage+"_i;\n"
				+ "`else\n"
				+ "  assign  "+WrNode+"_"+secondstage+"_s =0;\n"
				+ "`endif	\n"
				+ "	\n"
				+ "`ifdef "+WRTHIRD+"\n"
				...
				+ "	end\n"
				+ "// Write data \n"
				+ "assign "+WrNode+"_"+thirdstage+"_s = "+WrNode_validData+"_"+writebackstage+"_reg ?  "+WrNode+"_"+writebackstage+"_reg : "+WrNode+"_"+writebackstage+"_i;\n"
				+ "`else\n"
				+ "  assign  "+WrNode+"_"+thirdstage+"_s =0;\n"
				+ "`endif	\n"
				+ "\n"
				+ " \n"			
				+ " // Datahazard?\n"
				...
				+ "		assign DH_in_second"+RdNode+" = ("+RdInstr+"_"+firststage+"_i[15+"+addrW+"-1:15] == "+RdInstr+"_"+secondstage+"_i[7+"+addrW+"-1:7]) && "+RdNode_validReq+"_"+firststage+"_i && "+WrNode_validReq+"_"+secondstage+"_i;\n"
				+ "	else \n"
				+ "		assign DH_in_second"+RdNode+" = 0;\n"
				+ "	\n"
				+ "	if("+(writebackstage-firststage)+" > 1)\n"
				+ "		assign DH_in_third"+RdNode+" = ("+RdInstr+"_"+firststage+"_i[15+"+addrW+"-1:15] == "+RdInstr+"_"+thirdstage+"_i[7+"+addrW+"-1:7]) && "+RdNode_validReq+"_"+firststage+"_i && "+WrNode_validReq+"_"+thirdstage+"_i;\n"
				+ "	else \n"
				+ "		assign DH_in_third"+RdNode+" = 0;\n"
				+ "	\n"
				+ "	if("+(writebackstage-firststage)+" > 1 && RDSEC"+RdNode+" >0)\n"
				+ "		assign DH_fr_second_to_third"+RdNode+" = ("+RdInstr+"_"+secondstage+"_i[15+"+addrW+"-1:15] == "+RdInstr+"_"+thirdstage+"_i[7+"+addrW+"-1:7]) && "+RdNode_validReq+"_"+secondstage+"_i && "+WrNode_validReq+"_"+thirdstage+"_i;\n"
				+ "	else \n"
