...
public class ScheduleFront {
	...
	public Optional<PipelineFront> tryGetAsFront() {
		return Optional.ofNullable(asFront);
	}
	/**
	 * Returns the integer 'stagePos' value. If a PipelineFront is present or the value is invalid, the method will throw an UnsupportedOperationException.
	 */
	public int asInt() {
