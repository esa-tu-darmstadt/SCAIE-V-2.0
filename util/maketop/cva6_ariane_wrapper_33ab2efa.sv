...
module cva6_ariane_wrapper import ariane_pkg::*; import cvxif_pkg::*; #(
    // CVA6 config
...
assign cvxif_resp.x_compressed_ready = 1'b1;
assign cvxif_resp.x_compressed_resp.accept = 1'b0;
assign cvxif_resp.x_compressed_resp.instr = 32'd0;
assign cvxif_resp.x_issue_ready = 1'b1;
assign cvxif_resp.x_issue_resp.accept = 1'b0;
assign cvxif_resp.x_issue_resp.writeback = 1'b0;
assign cvxif_resp.x_issue_resp.dualwrite = 1'b0;
assign cvxif_resp.x_issue_resp.dualread = 1'b0;
assign cvxif_resp.x_issue_resp.loadstore = 1'b0;
assign cvxif_resp.x_issue_resp.exc = 1'b0;
assign cvxif_resp.x_mem_valid = 1'b0;
assign cvxif_resp.x_mem_req.id = '0;
assign cvxif_resp.x_mem_req.addr = '0;
assign cvxif_resp.x_mem_req.mode = '0;
assign cvxif_resp.x_mem_req.we = 1'b0;
assign cvxif_resp.x_mem_req.size = '0;
assign cvxif_resp.x_mem_req.wdata = '0;
assign cvxif_resp.x_mem_req.last = 1'b0;
assign cvxif_resp.x_mem_req.spec = 1'b0;
assign cvxif_resp.x_result_valid = 1'b0;
assign cvxif_resp.x_result.id = '0;
assign cvxif_resp.x_result.data = '0;
assign cvxif_resp.x_result.rd = '0;
assign cvxif_resp.x_result.we = 1'b0;
assign cvxif_resp.x_result.exc = 1'b0;
assign cvxif_resp.x_result.exccode = '0;
